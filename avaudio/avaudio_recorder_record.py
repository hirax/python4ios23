...
# クラスへのリファレンスを作る
try:
    AVAudioSession  = rubicon_objc.api.ObjCClass('AVAudioSession')
    AVAudioRecorder = rubicon_objc.api.ObjCClass('AVAudioRecorder')
    NSURL           = rubicon_objc.api.ObjCClass('NSURL')
except NameError:
