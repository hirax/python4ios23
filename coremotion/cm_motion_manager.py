...
class MotionManager:
    ...
    def create_accelerometer_handler(self):
        ...
        def accelerometer_f( _data: ctypes.c_void_p, _error: ctypes.c_void_p ) -> None:
            obj = rubicon_objc.api.ObjCInstance( _data ) # CMAccelerationData
            ...
            # blockを作る
        self.accelerometer_handler = rubicon_objc.api.Block(accelerometer_f)
    ...
    def create_magnetic_field_handler(self):
        ...
        def magnetic_field_f( _data: ctypes.c_void_p, _error: ctypes.c_void_p ) -> None:
            obj = rubicon_objc.api.ObjCInstance( _data ) # CMMagnetometerData
        ...
        self.magnetic_field_handler = rubicon_objc.api.Block(magnetic_field_f)
    ...
    def create_altitude_handler(self):
        ...
        def altitude_f( _data: ctypes.c_void_p, _error: ctypes.c_void_p ) -> None:
            obj = rubicon_objc.api.ObjCInstance( _data )
