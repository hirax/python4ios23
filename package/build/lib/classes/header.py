...
def member(obj, message, type):
    return rubicon_objc.send_message(obj, message, restype=type, argtypes=[])
...
CMMotionManager = rubicon_objc.api.ObjCClass('CMMotionManager')
CMDeviceMotion = rubicon_objc.api.ObjCClass('CMDeviceMotion')
CMAccelerometerData = rubicon_objc.api.ObjCClass('CMAccelerometerData')

CMAltimeter = rubicon_objc.api.ObjCClass('CMAltimeter')
CMAttitude = rubicon_objc.api.ObjCClass('CMAttitude')
# timestamp: NSTimeInterval: デバイス起動からの秒
# relativeAltitude: NSTimeInterval: 相対標高(m)
# pressure: NSNumber: 気圧(kパスカル)

AVCaptureSession = rubicon_objc.api.ObjCClass('AVCaptureSession')
AVCaptureConnection = rubicon_objc.api.ObjCClass('AVCaptureConnection')
AVCaptureDevice = rubicon_objc.api.ObjCClass('AVCaptureDevice')
AVCaptureDeviceInput = rubicon_objc.api.ObjCClass('AVCaptureDeviceInput')
AVCapturePhotoOutput = rubicon_objc.api.ObjCClass('AVCapturePhotoOutput')
AVCaptureVideoPreviewLayer = rubicon_objc.api.ObjCClass('AVCaptureVideoPreviewLayer')
AVCapturePhotoSettings = rubicon_objc.api.ObjCClass('AVCapturePhotoSettings')
AVCaptureDeviceDiscoverySession = rubicon_objc.api.ObjCClass('AVCaptureDeviceDiscoverySession')


CIFilter = rubicon_objc.api.ObjCClass('CIFilter')
CIVector = rubicon_objc.api.ObjCClass('CIVector')
CIColor = rubicon_objc.api.ObjCClass('CIColor')
CIImage = rubicon_objc.api.ObjCClass('CIImage')
#CGImage = rubicon_objc.api.ObjCClass('CGImage')
