...
import rubicon_objc
#import rubicon.objc as rubicon_objc

# クラスへのリファレンスを作る
try:
    AVSpeechSynthesizer = rubicon_objc.api.ObjCClass( 'AVSpeechSynthesizer' )
    AVSpeechSynthesisVoice = rubicon_objc.api.ObjCClass( 'AVSpeechSynthesisVoice' )
    AVSpeechUtterance = rubicon_objc.api.ObjCClass( 'AVSpeechUtterance' )
except NameError:
