...
AVMediaTypeText = 'text'
AVMediaTypeClosedCaption = 'clcp'
AVMediaTypeSubtitle = 'sbtl'
AVMediaTypeTimecode = 'tmcd'
AVMediaTypeMetadata = 'meta'
AVMediaTypeMuxed = 'muxx'
...
def manualCapture(
    ...
    objc_util.retain_global(delegate)
